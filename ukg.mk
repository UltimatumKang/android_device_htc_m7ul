...
# device
$(call inherit-product-if-exists, device/htc/m7ul/full_m7ul.mk)
...
PRODUCT_DEVICE := m7ul
PRODUCT_BRAND := HTC
PRODUCT_NAME := ukg_m7ul
PRODUCT_MODEL := HTC One
PRODUCT_MANUFACTURER := HTC
PRODUCT_PROPERTY_OVERRIDES += ro.buildzipid=ukg.m7ul.$(shell date +%m%d%y).$(shell date +%H%M%S)
...
PRODUCT_BUILD_PROP_OVERRIDES += \
    ...
    PRIVATE_BUILD_DESC="m7ul-user 4.2.2 JDQ39 573038 release-keys" \
    BUILD_FINGERPRINT="htc/m7ul:4.2.2/JDQ39/573038:user/release-keys"
